...
local assets = {
    Asset("ANIM", "anim/hoshino_item_nine.zip"), 
    Asset( "IMAGE", "images/inventoryimages/hoshino_item_nine.tex" ),  -- 背包贴图
    Asset( "ATLAS", "images/inventoryimages/hoshino_item_nine.xml" ),
}
----------------------------------------------------------------------------------------------------------------------------------------------------
-- workable install
    ...
    local function workable_install(inst)
        ...
        --         end
        --     end)
        --     replica_com:SetText("hoshino_item_nine","储蓄")
...
local function fn()
    ...
    inst.AnimState:SetBank("hoshino_item_nine") -- 地上动画
    inst.AnimState:SetBuild("hoshino_item_nine") -- 材质包，就是anim里的zip包
    ...
    ------ 物品名 和检查文本
        ...
        inst.components.inventoryitem.imagename = "hoshino_item_nine"
        inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_item_nine.xml"
...
return Prefab("hoshino_item_nine", fn, assets)