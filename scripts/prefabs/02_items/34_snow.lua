...
local assets = {
    Asset("ANIM", "anim/hoshino_item_snow.zip"), 
    Asset( "IMAGE", "images/inventoryimages/hoshino_item_snow.tex" ),  -- 背包贴图
    Asset( "ATLAS", "images/inventoryimages/hoshino_item_snow.xml" ),
}
----------------------------------------------------------------------------------------------------------------------------------------------------
-- workable install
    ...
    local function workable_install(inst)
        ...
        --         end
        --     end)
        --     replica_com:SetText("hoshino_item_snow","储蓄")
...
local function fn()
    ...
    inst.AnimState:SetBank("hoshino_item_snow") -- 地上动画
    inst.AnimState:SetBuild("hoshino_item_snow") -- 材质包，就是anim里的zip包
    ...
    ------ 物品名 和检查文本
        ...
        inst.components.inventoryitem.imagename = "hoshino_item_snow"
        inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_item_snow.xml"
...
return Prefab("hoshino_item_snow", fn, assets)