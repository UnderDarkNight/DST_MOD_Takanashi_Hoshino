...
--- 素材
    local assets =
    {
        ...
        Asset("IMAGE", "images/hoshino_mission/w_mission_b_17.tex"),
        Asset("ATLAS", "images/hoshino_mission/w_mission_b_17.xml"),
        Asset("IMAGE", "images/hoshino_mission/w_mission_s_17.tex"),
        Asset("ATLAS", "images/hoshino_mission/w_mission_s_17.xml"),
    }
...
--- net install
    local function Net_Vars_Install(inst)
        ...
        inst.__gears_num = net_uint(inst.GUID, "hoshino_mission_white_17.gears","hoshino_mission_white_17")
        inst.__wagpunk_bits_num = net_uint(inst.GUID, "hoshino_mission_white_17.wagpunk_bits","hoshino_mission_white_17")
        inst:ListenForEvent("hoshino_mission_white_17",function()
            inst.gears_num = inst.__gears_num:value()
            inst.wagpunk_bits_num = inst.__wagpunk_bits_num:value()
        end)
...
--- 用于平板显示的API，返回Widget图像。client端调用
    ...
    local GetPadDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/w_mission_s_17.xml","w_mission_s_17.tex"))
        --------------------------------------------------------------------------
        --- 放弃按钮
...
--- 用于任务栏显示的组件，返回Widget图像。client端调用
    local GetBoardDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/w_mission_b_17.xml","w_mission_b_17.tex"))
        ------- 任务描述
...
return Prefab("hoshino_mission_white_17", fn, assets)