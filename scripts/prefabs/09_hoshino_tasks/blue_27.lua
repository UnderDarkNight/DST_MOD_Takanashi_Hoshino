...
--- net install
    local function Net_Vars_Install(inst)
        ...
        inst.__bushhat_num = net_uint(inst.GUID, "hoshino_mission_blue_27.bushhat","hoshino_mission_blue_27")
    ...
    local GetPadDisplayBox = function(inst,box)
        ...
        --- 检查任务是否完成
            local update_fn = function()
                ...
                if archive_resonator_item_flag and bushhat_flag and nightmare_timepiece_flag then
...
--- 检查和提交
    local function Task_Delivery_Event_Install(inst)
        inst:ListenForEvent("task_delivery", function()
            ...
            if owner and Has_Enough_Items(owner,"archive_resonator_item",1) and Has_Enough_Items(owner,"bushhat",1) and Has_Enough_Items(owner,"nightmare_timepiece",1) then
                inst:Remove()
        ...
        local function mission_check()
            ...
            if owner then
                ...
                if archive_resonator_item_num >= 1 and bushhat_num >= 1 and nightmare_timepiece_num >= 1 then
