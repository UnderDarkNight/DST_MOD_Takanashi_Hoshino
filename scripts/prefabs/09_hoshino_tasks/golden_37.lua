...
--- 素材
    local assets =
    {
        Asset("IMAGE", "images/hoshino_mission/y_mission_b_37.tex"),
        Asset("ATLAS", "images/hoshino_mission/y_mission_b_37.xml"),
        Asset("IMAGE", "images/hoshino_mission/y_mission_s_37.tex"),
        Asset("ATLAS", "images/hoshino_mission/y_mission_s_37.xml"),
    }
...
--- 用于平板显示的API，返回Widget图像。client端调用
    ...
    local GetPadDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/y_mission_s_37.xml","y_mission_s_37.tex"))
        --------------------------------------------------------------------------
        --- 放弃按钮
...
--- 用于任务栏显示的组件，返回Widget图像。client端调用
    local GetBoardDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/y_mission_b_37.xml","y_mission_b_37.tex"))
        ------- 任务描述
...
return Prefab("hoshino_mission_golden_37", fn, assets)