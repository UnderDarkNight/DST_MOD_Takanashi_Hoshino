...
--- 素材
    local assets =
    {
        ...
        Asset("IMAGE", "images/hoshino_mission/w_mission_b_42.tex"),
        Asset("ATLAS", "images/hoshino_mission/w_mission_b_42.xml"),
        Asset("IMAGE", "images/hoshino_mission/w_mission_s_42.tex"),
        Asset("ATLAS", "images/hoshino_mission/w_mission_s_42.xml"),
    }
...
--- net install
    local function Net_Vars_Install(inst)
        inst.__num = net_uint(inst.GUID, "hoshino_mission_white_42","hoshino_mission_white_42")
        inst:ListenForEvent("hoshino_mission_white_42",function()
...
--- 用于平板显示的API，返回Widget图像。client端调用
    ...
    local GetPadDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/w_mission_s_42.xml","w_mission_s_42.tex"))
        --------------------------------------------------------------------------
        --- 放弃按钮
...
--- 用于任务栏显示的组件，返回Widget图像。client端调用
    local GetBoardDisplayBox = function(inst,box)
        local bg = box:AddChild(Image("images/hoshino_mission/w_mission_b_42.xml","w_mission_b_42.tex"))
        ------- 任务描述
...
return Prefab("hoshino_mission_white_42", fn, assets)