...
local function InitEnvelope()
    ...
    while t + step + .01 < 1 do
        table.insert(envs, { t, IntColour(80, 200, 200, 255) })
        -- table.insert(envs, { t, IntColour(TheWorld.R or 255, TheWorld.G or 255, TheWorld.B or 150, 255) })
        t = t + step
        table.insert(envs, { t, IntColour(80, 200, 200, 0) })
        -- table.insert(envs, { t, IntColour(TheWorld.R or 255,TheWorld.G or  255,TheWorld.B or 150, 0) })
        t = t + .01
    end
    table.insert(envs, { 1, IntColour(80,200, 200, 0) })
    -- table.insert(envs, { 1, IntColour(TheWorld.R or 255,TheWorld.G or  255, TheWorld.B or 150, 0) })
...
return Prefab("hoshino_sfx_victorian_fx", fn, assets)
