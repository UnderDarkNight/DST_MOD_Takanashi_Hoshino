...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_shoes_t4.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_shoes_t4.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_shoes_t4.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_shoes_t4.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_shoes_t4.xml",
            image = "hoshino_pad_equipment_shoes_t4.tex",
            -- inspect_txt = TUNING.HOSHINO_FNS:GetString("hoshino_special_equipment_shoes_t4","name") .. "\n"..TUNING.HOSHINO_FNS:GetString("hoshino_special_equipment_shoes_t4","recipe_desc"),
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_shoes_t4"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_shoes_t4.xml"
...
return Prefab("hoshino_special_equipment_shoes_t4", fn, assets)