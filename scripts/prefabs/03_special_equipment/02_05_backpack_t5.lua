...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_backpack_t5.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_backpack_t5.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_backpack_t5.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_backpack_t5.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_backpack_t5.xml",
            image = "hoshino_pad_equipment_backpack_t5.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，位面防御+10，经验值获取速率增加100%"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_backpack_t5"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_backpack_t5.xml"
...
return Prefab("hoshino_special_equipment_backpack_t5", fn, assets)