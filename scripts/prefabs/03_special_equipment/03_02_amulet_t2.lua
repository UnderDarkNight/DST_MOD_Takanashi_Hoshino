...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_amulet_t2.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_amulet_t2.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_amulet_t2.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_amulet_t2.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_amulet_t2.xml",
            image = "hoshino_pad_equipment_amulet_t2.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，免疫冰冻，半径30码内所有玩家获得15%减伤"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_amulet_t2"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_amulet_t2.xml"
...
return Prefab("hoshino_special_equipment_amulet_t2", fn, assets)