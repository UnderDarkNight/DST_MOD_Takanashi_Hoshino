...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_backpack_t8.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_backpack_t8.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_backpack_t8.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_backpack_t8.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_backpack_t8.xml",
            image = "hoshino_pad_equipment_backpack_t8.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，30码内的所有其他玩家受到伤害的60%会由自己承担，cost恢复+0.05/s"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_backpack_t8"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_backpack_t8.xml"
...
return Prefab("hoshino_special_equipment_backpack_t8", fn, assets)