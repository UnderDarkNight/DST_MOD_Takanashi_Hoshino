...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_amulet_t3.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_amulet_t3.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_amulet_t3.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_amulet_t3.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_amulet_t3.xml",
            image = "hoshino_pad_equipment_amulet_t3.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，金卡权重+5，彩卡权重+0.5，移动速度+10%"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_amulet_t3"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_amulet_t3.xml"
...
return Prefab("hoshino_special_equipment_amulet_t3", fn, assets)