...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_backpack_t3.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_backpack_t3.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_backpack_t3.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_backpack_t3.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_backpack_t3.xml",
            image = "hoshino_pad_equipment_backpack_t3.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，使人物身上的所有带有新鲜度的物品获得75%的保鲜效果，cost恢复速度+0.01/s"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_backpack_t3"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_backpack_t3.xml"
    ...
    --- 激活/反激活 相关的 事件安装
        inst.level = 3
        local active_event_install_fn = require("prefabs/03_special_equipment/02_00_backpack_fn_by_level")
...
return Prefab("hoshino_special_equipment_backpack_t3", fn, assets)