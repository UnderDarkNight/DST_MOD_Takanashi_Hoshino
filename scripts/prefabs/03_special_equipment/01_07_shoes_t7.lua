...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_shoes_t7.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_shoes_t7.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_shoes_t7.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_shoes_t7.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            ...
            -- inspect_txt = TUNING.HOSHINO_FNS:GetString("hoshino_special_equipment_shoes_t7","name") .. "\n"..TUNING.HOSHINO_FNS:GetString("hoshino_special_equipment_shoes_t7","recipe_desc"),
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_shoes_t7"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_shoes_t7.xml"
...
return Prefab("hoshino_special_equipment_shoes_t7", fn, assets)