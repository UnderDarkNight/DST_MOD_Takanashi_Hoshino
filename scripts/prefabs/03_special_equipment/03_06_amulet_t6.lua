...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_amulet_t6.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_amulet_t6.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_amulet_t6.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_amulet_t6.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_amulet_t6.xml",
            image = "hoshino_pad_equipment_amulet_t6.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，每次造成伤害都会扣除敌人1%最大生命。每有一个诅咒效果，基础攻击伤害增加50%"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_amulet_t6"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_amulet_t6.xml"
    ...
    --- 激活/反激活 相关的 事件安装
        inst.level = 6
        local active_event_install_fn = require("prefabs/03_special_equipment/03_00_amulet_fn_by_level")
...
return Prefab("hoshino_special_equipment_amulet_t6", fn, assets)