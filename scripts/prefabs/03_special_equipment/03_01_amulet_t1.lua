...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_amulet_t1.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_amulet_t1.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_amulet_t1.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_amulet_t1.xml" ),
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_amulet_t1"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_amulet_t1.xml"
...
return Prefab("hoshino_special_equipment_amulet_t1", fn, assets)