...
local assets =
{
    ...
    Asset( "IMAGE", "images/inventoryimages/hoshino_special_equipment_amulet_t7.tex" ),
    Asset( "ATLAS", "images/inventoryimages/hoshino_special_equipment_amulet_t7.xml" ),
    Asset( "IMAGE", "images/inspect_pad/hoshino_pad_equipment_amulet_t7.tex" ),
    Asset( "ATLAS", "images/inspect_pad/hoshino_pad_equipment_amulet_t7.xml" ),
...
local function fn()
    ...
    --- 给平板电脑的数据
        inst.pad_data = {
            atlas = "images/inspect_pad/hoshino_pad_equipment_amulet_t7.xml",
            image = "hoshino_pad_equipment_amulet_t7.tex",
            inspect_txt = TUNING.HOSHINO_FNS:GetString(inst.prefab,"inspect_str") or "拥有其下位的效果，半径30码内的枯萎植物会恢复，半径30码内的玩家会每10s恢复3点生命值"
    ...
    inst.components.inventoryitem.imagename = "hoshino_special_equipment_amulet_t7"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/hoshino_special_equipment_amulet_t7.xml"
...
return Prefab("hoshino_special_equipment_amulet_t7", fn, assets)