...
return function(inst,front_root)
        ...
        --- 货币按钮组
            ...
            refresh_button.inst:ListenForEvent("hoshino_event.shop_refresh_cost",function()
                local refresh_cost = ThePlayer.HOSHINO_SHOP and ThePlayer.HOSHINO_SHOP.refresh_cost or 0
                refresh_cost_text:SetString(tostring(refresh_cost))
            end,ThePlayer)
            ThePlayer:PushEvent("hoshino_event.shop_refresh_cost")
            local refresh_free_times_text = refresh_button:AddChild(Text(CODEFONT,35,"500",{ 0/255 , 0/255 ,0/255 , 1}))
            refresh_free_times_text:SetPosition(0,-40)
            refresh_button.inst:ListenForEvent("hoshino_event.shop_refresh_count",function()
                ...
                refresh_free_times_text:SetString("免费次数 : "..tostring(refresh_count))
            end,ThePlayer)
