...
--- 获取物品列表并修正价格。
    ...
    function hoshino_com_shop:Spawn_Items_List_And_Send_2_Client(new_force)
        ...
        self:ShopData_Set("new_items_list_spawned_flag.normal",math.random(100000))    --- 让列表滚动条不被刷新用
        self:ShopData_Set("normal_items",normal_items)
        self:ShopData_Set("new_items_list_spawned_flag.special",math.random(100000))   --- 让列表滚动条不被刷新用
