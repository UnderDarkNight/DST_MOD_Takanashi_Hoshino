...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
 -- 這裡放hoshino的技能參數
    ...
    TUNING.HOSHINO_PARAMS.SPELLS.NORMAL_HEAL_COST = 4       -- 消耗
    TUNING.HOSHINO_PARAMS.SPELLS.NORMAL_HEAL_BUFF_REMAIN_TIME = 30  -- buff持续时间
    TUNING.HOSHINO_PARAMS.SPELLS.NORMAL_HEAL_BUFF_HEAL_PERCENT_PRE_SECOND = 0.03 -- 每秒回血百分比
    TUNING.HOSHINO_PARAMS.SPELLS.NORMAL_HEAL_MOUSE_OVER_TEXT = "在30秒内每秒回复自身3%的生命值"
    -- 【普通模式】隐秘行动
    ...
    -- 【游泳模式】EX支援
    TUNING.HOSHINO_PARAMS.SPELLS.SWIMMING_EX_SUPPORT_CD = 70    -- cd时间
    ...
    TUNING.HOSHINO_PARAMS.SPELLS.SWIMMING_EMERGENCY_ASSISTANCE_COST = 2 -- 消耗
    ...
    TUNING.HOSHINO_PARAMS.SPELLS.SWIMMING_DAWN_OF_HORUS_COST = 3 -- 消耗
