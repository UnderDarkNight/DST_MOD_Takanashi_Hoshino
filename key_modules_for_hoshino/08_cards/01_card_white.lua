...
local cards = {
    ...
    --- 12、【白】【荆棘】【每次受到攻击时候，对伤害来源直接反伤3点（任何玩家都不会触发这个）】【可叠加】
        ["counter_damage"] = {
            ...
            text = function(inst)
                return "【荆棘】 固有，每次受到攻击时，对伤害来源造成10点伤害"
            end,
            skip_ever_remove = true,  --- 不会被永久移除
        },
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    --- 【白】【似曾相识】标记月岛和远古的位置（选择后从卡池移除）
        ...
        ["mark_moon_land_and_ancient_land"] = {
            ...
            text = function(inst)
                return "【似曾相识】标记月岛或远古的位置（选择后从卡池移除）"
            end,
        },
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    --- 【白】【祭品】三维MAX-10，移速，攻击倍率-5%，卡牌刷新次数+30
        ["sacrifice_white"] = {
            ...
            text = function(inst)
                return "【祭品】\n三维上限-10，移速，攻击倍率-5%，卡牌刷新次数+30"
            end,
        },
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --- 【白】【工作日】今日获得五次额外的委托刷新次数
        ["workday"] = {
            back = "card_white",
            front = {atlas = "images/inspect_pad/page_level_up.xml" ,image = "card_white.tex"},
            test = function(inst)
            ...
            fn = function(inst)
                inst.components.hoshino_com_task_sys_for_player:Refresh_DoDelta(5)
            end,
            text = function(inst)
                return "【工作日】今日获得五次额外的委托刷新次数"
            end,
        },
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
