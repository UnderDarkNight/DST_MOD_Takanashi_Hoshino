...
local cards = {
    ...
    --- 【彩】【虚空之喉】每当玩家进行一次攻击动作，获得一个围绕在玩家周围（半径为4.5）的，持续3s的黑圈，触碰到黑圈的敌人每0.05s受到15真实伤害（受攻击倍率影响，无伤害来源），且被黑圈杀死的敌人有3%的概率给予玩家一层【爆炸护盾】【重复选择伤害和概率叠加】
        ["void_throat"] = {
            ...
            text = function(inst)
                return " \n【虚空之喉】每当玩家进行一次攻击动作，获得持续3s的黑圈\n触碰到黑圈的敌人受到高频真实伤害黑圈杀死目标时\n3%的概率给予一层【爆炸护盾】【重复选择伤害和概率叠加】"
            end,
        },
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --- 【彩】【混沌】使你的所有卡牌权重变为相等
    ...
    --- 【彩】【狸猫树叶】当你超过一秒未进行任何操作时，免疫所有血量扣除，一旦进行任何操作就会失去上述免疫效果。【选择后从卡组移除】
        ["raccoon_leaf"] = {
            ...
            front = {atlas = "images/inspect_pad/page_level_up.xml" ,image = "card_colourful.tex"},
            test = function(inst)
                return inst:GetDebuff("hoshino_card_debuff_raccoon_leaf") == nil
            end,
            fn = function(inst)
