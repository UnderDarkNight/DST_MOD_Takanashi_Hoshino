...
--- 基础API
    local has_icon = {
        ...
        ["air_drop_support"] = true,
        ["air_drop_support_golden"] = true,
        ["amblyopia"] = true,
        ["armored_warrior"] = true,
        ["armor_damage_type_resist"] = true,
        ["armor_down_blocker_percent"] = true,
        ["armor_planar_defense"] = true,
        ["a_lifesaver"] = true,
        ["black_beggar"] = true,
        ["block_monster_health_auto_up"] = true,
        ["bloodshed"] = true,
        ["buff_health_down_and_coins_up"] = true,
        ["burdened_forward"] = true,
        ...
        ["cat_hand"] = true,
        ["chaos"] = true,
        ["coins_and_dmg_up"] = true,
        ["collecting_fetish"] = true,
        ["counter_damage"] = true,
        ...
        ["kill_and_coins_up_thief"] = true,
        ["kill_and_explode"] = true,
        ["level_up_and_double_card_pack"] = true,
        ["mark_moon_land_and_ancient_land"] = true,
        ["max_daily_earn"] = true,
        ["max_health_1"] = true,
        ...
        ["mediocre"] = true,
        ["moisture_and_dmg"] = true,
        ["moisture_down_blocker"] = true,
        ["more_default_selectting_cards"] = true,
        ["neatness_obsession"] = true,
        ["nine_lives_cat"] = true,
        ["no_entry_kitchen"] = true,
        ["only_epic_exp"] = true,
        ["pad_stone"] = true,
        ...
        ["sacrifice_colourful"] = true,
        ["sacrifice_white"] = true,
        ["sanity_ever_zero"] = true,
        ["seek_good_avoid_bad"] = true,
        ["set_the_same_followers"] = true,
        ["shop_price_increase"] = true,
        ["sleeping_bag_health_blocker"] = true,
        ["solitary_heaven_path"] = true,
        ["speed_up_2_percent"] = true,
        ["speed_up_and_damage_up_6_10"] = true,
        ["spring"] = true,
        ["substantive_strike"] = true,
        ["summon_rocky"] = true,
        ["the_eye_of_horus_finiteuses_down_block"] = true,
        ["the_rsistance_of_horus"] = true,
        ["the_tail_of_the_fart_cat"] = true,
        ["thunder_thighs"] = true,
        ["tower_curse"] = true,
        ["trading_master_pigking_and_gems"] = true,
        ...
        ["war_chariot"] = true,
        ["weapon_damage_up_by_range"] = true,
        ["workday"] = true,
        ["year_round"] = true,
    }
