...
--  palmcone_seed
{
  prefab = "palmcone_seed",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("palmcone_seed.tex"), image = "palmcone_seed.tex"},
  price = 50, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  cutgrass
{
  ...
  price = 500, -- 价格
  num_to_give = 40, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
  type = "normal", -- 类型。normal special 。这个可以不下发。
  is_permanent = true, -- 是否永久。0 非永久 1 永久
...
--  beefalofeed
{
  prefab = "beefalofeed",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("beefalofeed.tex"), image = "beefalofeed.tex"},
  price = 100, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  hambat
{
  prefab = "hambat",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("hambat.tex"), image = "hambat.tex"},
  price = 150, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  dug_sapling
{
  prefab = "dug_sapling",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("dug_sapling.tex"), image = "dug_sapling.tex"},
  price = 60, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  dug_sapling_moon
{
  prefab = "dug_sapling_moon",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("dug_sapling_moon.tex"), image = "dug_sapling_moon.tex"},
  price = 90, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  dug_grass
{
  prefab = "dug_grass",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("dug_grass.tex"), image = "dug_grass.tex"},
  price = 50, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  dug_berrybush
{
  ...
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("dug_berrybush.tex"), image = "dug_berrybush.tex"},
  price = 130, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  dug_berrybush2
{
  prefab = "dug_berrybush2",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("dug_berrybush2.tex"), image = "dug_berrybush2.tex"},
  price = 150, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
{
  prefab = "halloweenpotion_moon",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("halloweenpotion_moon.tex"), image = "halloweenpotion_moon.tex"},
  price = 66, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
{
  prefab = "hoshino_building_white_drone_item",
  bg = "item_slot_blue.tex",
  icon = {atlas = "images/inventoryimages/hoshino_building_white_drone_item.xml", image = "hoshino_building_white_drone_item.tex"},
  price = 2700, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  driftwood_log
{
  prefab = "driftwood_log",
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("driftwood_log.tex"), image = "driftwood_log.tex"},
  price = 45, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
...
--  goose_feather
{
  ...
  bg = "item_slot_blue.tex",
  icon = {atlas = GetInventoryItemAtlas("goose_feather.tex"), image = "goose_feather.tex"},
  price = 90, -- 价格
  num_to_give = 1, -- 单次购买的数量。【注意】nil 自动处理为1。
  price_type = "credit_coins", -- 货币需求。
  level = 1, -- 等级限制。这个可以不下发。用来解锁。 【注意】做nil 自动处理为0。
